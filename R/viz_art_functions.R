...
#' 
#' `Lego_vizart_plot_heatmap` creates various heatmaps and plots TADs. 
#' 
...
#' that if a Lego store matrix was loaded until a certain distance, this parame-
...
#' either the first or the second Lego stores. This must be a numeric value
