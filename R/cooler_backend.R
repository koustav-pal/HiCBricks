...
#     ChromInfo <- Brick_get_chrominfo(Brick = Brick, resolution = binsize)
...
#         chr1 = chr1, chr2 = chr2, resolution = binsize)
...
#     metrics.list <- populate_matrix_with_values(Brick = Brick_filepath, 
#         File = File, group.path = group.path, starts.1 = Starts, 
#         ends.1 = Ends, starts.2 = Chrom2.starts, ends.2 = Chrom2.ends, 
#         chrom1 = chr1, chrom1.offset = Index.chrom.offset[chrom1.loc],
