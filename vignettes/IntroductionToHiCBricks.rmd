...
Bintable.path <- system.file(file.path("extdata",
...
In the previous example for 2D text matrices, we used the `Create_many_Bricks` function to create _Brick objects_ for 2D matrices. Instead, to create _Brick objects_ from _mcool_ files we will use the `CreateBrick_from_mcool` function. 
...
Brick_load_data_from_mcool(Brick = My_BrickContainer,
    ...
    chr2 = "chr1",
    resolution = 10000,
    cooler_batch_size = 1000000,
    matrix_chunk = 2000,
    dont_look_for_chr2 = TRUE,
    remove_prior = TRUE,
    norm_factor = "Iterative-Correction")

```

There are a few options allowing users to manipulate data read and write speed. `cooler_batch_size` determines the data read buffer size. `matrix_chunk` determines data write buffer, i.e. the size of the matrix square that will be loaded per iteration through an _mcool_ file. If you are loading *cis* (intra-chromosomal) contact matrices, it is recommended to set the `dont_look_for_chr2` parameter to TRUE to speed up the loading of data. In cases of *trans* (inter-chromosomal) contact matrices, this option should be set to FALSE. `remove_prior` defaults to FALSE to prevent users from overwriting data already loaded into an HDF file.
...
BrickContainer_file <- system.file(file.path("extdata", 
...
Brick_get_values_by_distance(Brick = My_BrickContainer,
    chr = "chr2L",
    distance = 4,
    constrain_region = "chr19:1:5000000",
    resolution = 100000,
    FUN = Failsafe_median_log10)
...
Sub.matrix <- Brick_get_matrix_within_coords(Brick = My_BrickContainer,
    x_coords="chr19:5000000:10000000",
    force = TRUE,
    resolution = 100000,
    y_coords = "chr19:5000000:10000000")
...
x_axis <- 5000000/40000
y_axis <- 10000000/40000

Sub.matrix <- Brick_get_matrix(Brick = My_BrickContainer,
    chr1 = "chr2L", chr2 = "chr2L", resolution = 100000,
    x_vector = seq(from = x_axis, to = y_axis),
    y_vector = seq(from = x_axis, to = y_axis))
...
Test_Run <- Brick_fetch_row_vector(Brick = Brick.file,
    ...
    vector = Coordinate,
    resolution = 100000,
    regions = c("chr2L:1:1000000", "chr2L:100001:2000000"))
...
Brick_list_rangekeys(Brick = My_BrickContainer)
...
Brick_vizart_plot_heatmap(File = file.path(tempdir(), 
  "chr2L-1-10MB-normal.pdf"),
    Bricks = My_BrickContainer,
    x_coords = "chr2L:1:10000000",
    y_coords = "chr2L:1:10000000",
    palette = "Reds",
    width = 10,
    height = 11,
    return_object=TRUE)
...
Brick_vizart_plot_heatmap(File = file.path(tempdir(), 
  "chr2L-1-10MB-normal-colours-log10.pdf"),
    Bricks = My_BrickContainer,
    x_coords = "chr2L:1:10000000",
    y_coords = "chr2L:1:10000000",
    FUN = Failsafe_log10,
...
Brick_vizart_plot_heatmap(File = file.path(tempdir(),
  "chr2L-1-10MB-normal-colours-log10-valuecap-99.pdf"),
    Bricks = My_BrickContainer,
    x_coords = "chr2L:1:10000000",
    y_coords = "chr2L:1:10000000",
    FUN = Failsafe_log10,
...
Brick_vizart_plot_heatmap(File = file.path(tempdir(),
  "chr2L-1-10MB-normal-colours-log10-rotate.pdf"),
    Bricks = My_BrickContainer,
    x_coords = "chr2L:1:10000000",
    y_coords = "chr2L:1:10000000",
    FUN = Failsafe_log10,
...
Brick_vizart_plot_heatmap(File = file.path(tempdir(),
  "chr2L-1-10MB-normal-colours-log10-rotate-2.pdf"),
    Bricks = My_BrickContainer,
    x_coords = "chr2L:1:10000000",
    y_coords = "chr2L:1:10000000",
    FUN = Failsafe_log10,
...
Brick_vizart_plot_heatmap(File = file.path(tempdir(),
  "chr2L-1-10MB-normal-colours-log10-rotate-2-tads.pdf"),
    Bricks = My_BrickContainer,
...
Brick_vizart_plot_heatmap(File = file.path(tempdir(),
  "chr2L-1-10MB-normal-colours-log10-rotate-3-tads.pdf"),
    Bricks = My_BrickContainer,
    tad_ranges = TAD_ranges,
    x_coords = "chr2L:1:10000000",
    y_coords = "chr2L:1:10000000",
...
Brick_vizart_plot_heatmap(File = file.path(tempdir(),
  "chr2L-1-10MB-bipartite-colours-log10-valuecap-99.pdf"),
    Bricks = c(My_BrickContainer, My_BrickContainer),
    x_coords = "chr2L:1:10000000",
    y_coords = "chr2L:1:10000000",
    FUN = Failsafe_log10,
    value_cap = 0.99,
...
Brick_vizart_plot_heatmap(File = file.path(tempdir(),
  "chr2L-1-10MB-bipartite-colours-log10-valuecap-99-2.pdf"),
    Bricks = c(My_BrickContainer, My_BrickContainer),
    x_coords = "chr2L:1:10000000",
    y_coords = "chr2L:1:10000000",
    FUN = Failsafe_log10,
...
Brick_vizart_plot_heatmap(File = file.path(tempdir(),
  "chr2L-1-10MB-bipartite-colours-log10-valuecap-99-rotate.pdf"),
    Bricks = c(My_BrickContainer, My_BrickContainer),
    x_coords = "chr2L:1:10000000",
    y_coords = "chr2L:1:10000000",
    FUN = Failsafe_log10,
...
Brick_vizart_plot_heatmap(File = file.path(tempdir(),
  "chr2L-1-10MB-bipartite-colours-log10-valuecap-99-tads.pdf"),
    Bricks = c(My_BrickContainer, My_BrickContainer),
    x_coords = "chr2L:1:10000000",
    y_coords = "chr2L:1:10000000",
    FUN = Failsafe_log10,
...
Brick_vizart_plot_heatmap(File = file.path(tempdir(),
  "chr2L-1-10MB-bipartite-colours-log10-valuecap-99-rotate-tads.pdf"),
...
Brick_vizart_plot_heatmap(File = file.path(tempdir(),
  "chr2L-1-10MB-bipartite-colours-log10-valuecap-99-rotate-tads-2.pdf"),
    Bricks = c(My_BrickContainer, My_BrickContainer),
    x_coords = "chr2L:1:10000000",
    y_coords = "chr2L:1:10000000",
    FUN = Failsafe_log10,
...
Brick_vizart_plot_heatmap(File = file.path(tempdir(),
  "chr2L-1-10MB-bipartite-final.pdf"),
    Bricks = c(Brick.file, Brick.file),
    x_coords = "chr2L:1:10000000",
    y_coords = "chr2L:1:10000000",
    FUN = Failsafe_log10,
