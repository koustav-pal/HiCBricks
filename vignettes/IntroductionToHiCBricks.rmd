...
Nature 2012]. It partitions the genome into segments based on the local 
directionality index distribution. We first introduced this procedure with 
our study Pal et al., 2019. This has been adapted to work with HiCBricks to 
show how different analysis procedures can take advantage of the HiCBricks 
accessor functions.  
...
Using HiCBricks functions, users can plot pretty Hi-C heatmaps. This lists the
...
```{r plot4, fig.cap = "Figure 4. Same heatmap as before with colours computed in log10 scale after capping values to the 99th percentile with 90 degree rotation", fig.small = TRUE}
