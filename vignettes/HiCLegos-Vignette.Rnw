...
\noindent Although it is possible to load all chromosomes in a single Lego object, 
...
<<eval=FALSE, label=chr19-5MB-10MB-normal, include=FALSE, echo=TRUE>>=
...
<<eval=FALSE, label=chr19-5MB-10MB-normal3, include=FALSE, echo=TRUE>>=
...
<<eval=FALSE, label=chr19-5MB-10MB-normal4, include=FALSE, echo=TRUE>>=
...
<<eval=FALSE, label=chr19-5MB-10MB-normal5, include=FALSE, echo=TRUE>>=
...
<<eval=FALSE, label=chr19-5MB-10MB-normal6, include=FALSE, echo=TRUE>>=
...
<<eval=FALSE, label=chr19-5MB-10MB-normal7, include=FALSE, echo=TRUE>>=
Lego_vizart_plot_heatmap(File = "chr19-5MB-10MB-normal.pdf", 
    Legos = Lego.file, 
    tad.ranges = TAD_ranges,
    x.coords = "chr19:5000000:10000000", 
...
@
\caption{Rotated Hi-C matrix with TADs and a differen color palette.}
\label{fig:Fig7}
\end{figure}
