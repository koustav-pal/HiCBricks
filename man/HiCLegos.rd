...
\itemize{
\item \code{\link{Lego_is_tracked}} - Check if a Lego is being tracked
\item \code{\link{Lego_untrack_lego}} - Untrack the Lego file at path, if
it is being tracked
\item \code{\link{Lego_track_legos}} - Track the Lego file at path
\item \code{\link{Lego_list_tracked_legos}} - List all Legos that are being
tracked by the HiCLegos package.
}
}
